...
const Header = () => {
  ...
  return (
   ...
   <h1 className='text-xl md:text-3xl font-Ovo  text-right'>Building the future of the web - <br /> one line of code at a time.</h1>
        ...
        <a href="#contact" className='flex gap-2 items-center bg-slate-400 py-2 px-3 rounded-3xl bg-opacity-50 shadow-xl'>Contact Me<Image alt='' src={assets.arrowStraight} width='20'/></a>
